...
- 2026-07-19: Removed redundant float() casting when iterating over lists derived from numpy arrays in polygon_geometry.py to avoid python function call overhead.
