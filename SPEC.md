...
- 2026-07-21: Optimized `_fast_serialize_node` in `mjcf_helpers.py` by inlining string replacements for escaping and reducing function signature to speed up MJCF XML generation.
